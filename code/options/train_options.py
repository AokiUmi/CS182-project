...
class TrainCompOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--model', type=str, default="motionclip", help='num_layers of transformer')
        self.parser.add_argument('--emb_type', type=str, default="bert", help='text embedding type')
        self.parser.add_argument('--finetune', action="store_true", help='text embedding type')
        ...
        self.parser.add_argument('--num_epochs', type=int, default=50000000, help='Number of epochs')
        ...
        self.parser.add_argument('--feat_bias', type=float, default=3, help='Scales for global motion features and foot contact')

        self.parser.add_argument('--rewake', action="store_true", help='Is this trail continued from previous trail?')
        ...
        self.parser.add_argument('--save_latest', type=int, default=2000, help='Frequency of saving models (by iteration)')
        self.is_train = True
